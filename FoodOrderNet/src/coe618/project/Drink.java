...
public class Drink extends Menu implements CustomerInterface{
    ...
    public void manager(){
        ...
        while(tmp == 1){
            ...
            System.out.print("Do you want to add a new Drink? Y:any number N: 9)"); 
    ...
    public void choosemenu(){
        ...
        while(tmp == 0){
            System.out.print("Choose Drink (9 to exit): ");
            Scanner scan = new Scanner(System.in);
            input = scan.nextInt();
            if(input == 9) tmp = 1;
