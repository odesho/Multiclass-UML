...
public class Pizza extends Menu implements CustomerInterface{
   ...
   public void manager(){
        ...
        while(tmp == 1){
            ...
            System.out.print("Do you want to add a new Pizza ? Y:any number N: 9)"); 
    ...
    public void choosemenu(){
        ...
        int tmp = 0;
        int m = 1;
        for (foodItem i: pizza.menulist){
            m++;
        }
        while(tmp == 0){
            System.out.print("Choose Pizza (9 to exit): ");
            Scanner scan = new Scanner(System.in);
            input = scan.nextInt();
            if(input == 9) tmp = 1;
